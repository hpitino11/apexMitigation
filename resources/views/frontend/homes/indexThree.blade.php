...
@section('content')
    ...
    <!-- header area end -->
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="main-slider-three__social-links">
                            ...
                            <ul class="social-links">
                                <li><a href="#"><span class="icon-letter-v"></span></a></li>
                        ...
                        <div class="container">
                            <div class="main-slider-three__single text-center">
                                <div class="main-slider-three__content">
                                    <div class="logo-box">
                                        <img src="{{ asset('/assets/img/resource/main-slider-v3-logo.png') }}" alt="" loading="lazy">
                                    </div>
                                    <div class="title">
        ...
        <!--Start Feauture One-->
        <section class="feauture-one style2">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="about-three__img">
                            <div class="about-three__img1">
                                <div class="inner">
                                    <img src="{{ asset('/assets/img/about/about-v3-img1.jpg') }}" alt="" loading="lazy">
                                </div>
                            ...
                            <div class="about-three__img2">
                                <ul>
                                    <li>
                                        <div class="about-three__img2-single">
                                            <img src="{{ asset('/assets/img/about/about-v3-img2.jpg') }}" alt="" loading="lazy">
                                        </div>
                                    </li>

                                    <li>
                                        <div class="about-three__img2-single">
                                            <img src="{{ asset('/assets/img/about/about-v3-img3.jpg') }}" alt="" loading="lazy">
                                        </div>
                                    </li>
                                </ul>
                            </div>
        ...
        <section class="project-three">
            <div class="shape1"><img src="{{ asset('/assets/img/shape/project-v3-shape1.png') }}" alt="" loading="lazy"></div>
            <div class="container">
                ...
                <div class="project-three__bottom">
                    ...
                    "navigation": {
                        "nextEl": "#project-three__swiper-button-next",
                        "prevEl": "#project-three__swiper-button-prev"
                    },
                    "autoplay": { "delay": 5000 },
                    "breakpoints": {
                        "0": {
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="project-three__single">
                                    <ul class="project-three__box">
                                        <li>
                                            <div class="project-three__single-inner">
                                                <div class="project-three__single-img"
                                                    style="background-image: url(assets/img/project/project-v3-img1.jpg);">
                                                </div>
                                                <div class="bg-overlay"></div>

                                                <div class="project-three__overlay-icon">
                                                    <ul>
                                                        <li><a class="img-popup"
                                                                href="{{ url('assets/img/project/project-v3-img1.jpg') }}"><span
                                                                    class="icon-search-interface-symbol"></span></a>
                                                        </li>
                                                        <li><a href="{{ route('projectDetails') }}"><span
                                        ...
                                        <li>
                                            <div class="project-three__single-inner">
                                                <div class="project-three__single-img"
                                                    style="background-image: url(assets/img/project/project-v3-img2.jpg);">
                                                </div>
                                                <div class="bg-overlay"></div>
                                                ...
                                                <div class="project-three__overlay-icon">
                                                    <ul>
                                                        <li><a class="img-popup"
                                                                href="{{ url('assets/img/project/project-v3-img2.jpg') }}"><span
                                                                    class="icon-search-interface-symbol"></span></a>
                                                        </li>
                                                        <li><a href="{{ route('projectDetails') }}"><span
                                                                    class="icon-link"></span></a></li>
                                        ...
                                        <li>
                                            <div class="project-three__single-inner">
                                                <div class="project-three__single-img"
                                                    style="background-image: url(assets/img/project/project-v3-img3.jpg);">
                                                </div>
                                                <div class="bg-overlay"></div>
                                                ...
                                                <div class="project-three__overlay-icon">
                                                    <ul>
                                                        <li><a class="img-popup"
                                                                href="{{ url('assets/img/project/project-v3-img3.jpg') }}"><span
                                                                    class="icon-search-interface-symbol"></span></a>
                                                        </li>
                                                        <li><a href="{{ route('projectDetails') }}"><span
                                                                    class="icon-link"></span></a></li>
                    ...
                    <ul>
                        <li class="awards-one__single">
                            <div class="content-box">
                                ...
                                <div class="logo-box">
                                    <img src="{{ asset('/assets/img/resource/awards-v1-logo1.png') }}" alt="" loading="lazy">
                                </div>
                                <div class="text-box">
                            ...
                            <div class="awards-one__img"><img class="awards-one__img-hover"
                                    src="{{ asset('/assets/img/resource/awards-v1-img1.jpg') }}" alt="#" loading="lazy"></div>
                        </li>
                        ...
                        <li class="awards-one__single">
                            ...
                            <div class="awards-one__img"><img class="awards-one__img-hover"
                                    src="{{ asset('/assets/img/resource/awards-v1-img2.jpg') }}" alt="#" loading="lazy"></div>
                        </li>
                        ...
                        <li class="awards-one__single">
                            ...
                            <div class="awards-one__img"><img class="awards-one__img-hover"
                                    src="{{ asset('/assets/img/resource/awards-v1-img3.jpg') }}" alt="#" loading="lazy"></div>
                        </li>
                        ...
                        <li class="awards-one__single">
                            ...
                            <div class="awards-one__img"><img class="awards-one__img-hover"
                                    src="{{ asset('/assets/img/resource/awards-v1-img4.jpg') }}" alt="#" loading="lazy"></div>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <!--Start Feauture Two-->
        <section class="feauture-two style4">
            <div class="container">
                <div class="row">
                    <!--Start Feauture Two Single-->
                    <div class="col-xl-6 wow animated fadeInLeft" data-wow-delay="0.1s">
                        <div class="feauture-two__single">
                            <div class="feauture-two__single-img"
                                style="background-image: url(assets/img/resource/feauture-v2-img1.jpg);">
                                <div class="icon-box">
                    ...
                    <div class="col-xl-6 wow animated fadeInRight" data-wow-delay="0.1s">
                        <div class="feauture-two__single">
                            <div class="feauture-two__single-img"
                                style="background-image: url(assets/img/resource/feauture-v2-img2.jpg);">
                                <div class="icon-box">
        ...
        <section class="video-one video-one--two">
            ...
            <div class="video-one__pattern"><img src="{{ asset('/assets/img/pattern/video-v1-pattern.png') }}" alt="" loading="lazy"></div>
            <div class="auto-container">
                <div class="video-one__inner text-center">
                    <div class="shape1 float-bob-x"><img src="{{ asset('/assets/img/shape/video-v1-shape1.png') }}" alt="" loading="lazy"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="blog-one__single">
                            <div class="blog-one__single-img">
                                <div class="inner">
                                    <img src="{{ asset('/assets/img/blog/blog-v2-img1.jpg') }}" alt="" loading="lazy">
                            ...
                            <div class="blog-one__single-content">
                                ...
                                <h2><a href="{{ route('blogDetails') }}">Architecture is a Visual Art <br>
                                        the Buildings Speak For </a></h2>
                                <div class="btn-box">
                                    <a href="{{ route('blogDetails') }}">READ MORE <span class="icon-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="blog-one__single">
                            <div class="blog-one__single-img">
                                <div class="inner">
                                    <img src="{{ asset('/assets/img/blog/blog-v2-img2.jpg') }}" alt="" loading="lazy">
                                    <div class="overlay-icon">
                                        <a href="#"><span class="icon-plus"></span></a>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="blog-one__single">
                            <div class="blog-one__single-img">
                                <div class="inner">
                                    <img src="{{ asset('/assets/img/blog/blog-v2-img3.jpg') }}" alt="" loading="lazy">
                                    <div class="overlay-icon">
                                        <a href="#"><span class="icon-plus"></span></a>
                                    </div>
                                </div>
