...
@section('title', 'Building Architecture')
@section('content')
    <!-- header area -->
            ...
            <div class="container">
                <div class="page-header__inner text-center">
                    <ul class="thm-breadcrumb">
                        ...
                        <li class="active">Building Architecture</li>
                    </ul>
                    ...
                    <div class="col-xl-8">
                        <div class="services-details__content">
                            <div class="services-details__content-img1">
                                <img src="{{ asset('/assets/img/service/services-details-img1.jpg') }}" alt="#" loading="lazy">
                            </div>
                            ...
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list">
                                    ...
                                    <li><a href="{{ route('uiuxDesign') }}">Ui/Ux Designing <span
                                                class="icon-left-arrow"></span></a></li>
                                    <li><a href="{{ route('buildingRenovation') }}">Building Renovation <span
                                                class="icon-left-arrow"></span></a></li>
